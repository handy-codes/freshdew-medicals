...
// Full-page cache purge (LiteSpeed, WP Rocket, etc.) + filemtime-based asset versions.
require_once get_template_directory() . '/inc/freshdew-cache-purge.php';
...
function freshdew_enqueue_assets() {
    $asset_ver = function_exists( 'freshdew_get_assets_version' ) ? freshdew_get_assets_version() : wp_get_theme()->get( 'Version' );

    // Styles
    wp_enqueue_style('freshdew-style', get_stylesheet_uri(), array(), $asset_ver);
    wp_enqueue_style(
        'freshdew-hero-marquee',
        get_template_directory_uri() . '/assets/css/hero-marquee.css',
        array('freshdew-style'),
        $asset_ver
    );
    wp_enqueue_style('freshdew-main', get_template_directory_uri() . '/assets/css/main.css', array(), $asset_ver);
    
    // Scripts
    wp_enqueue_script('freshdew-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), $asset_ver, true);
