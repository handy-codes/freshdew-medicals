<?php
/**
 * Vacation notice marquee — markup only; styles in assets/css/hero-marquee.css (v7).
 *
...
?>
<!-- fd-marquee-v7: <?php echo esc_attr( $fd_marquee_build ); ?> -->
<div class="fd-hero-marquee fd-hero-marquee--v7" role="region" aria-label="<?php echo esc_attr__( 'Vacation notice', 'freshdew-medical' ); ?>" data-fd-marquee-v="7" data-fd-marquee-build="<?php echo esc_attr( $fd_marquee_build ); ?>">
