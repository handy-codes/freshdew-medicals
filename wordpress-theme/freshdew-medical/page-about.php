        ...
        <div style="max-width: 1200px; margin: 0 auto;">
            ...
            <div style="display: flex; flex-direction: column; gap: 2.5rem; margin-bottom: 4rem;">
                ...
                <div class="team-card" style="background: white; border-radius: 0.75rem; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; display: flex; flex-direction: column;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 12px rgba(0,0,0,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)';">
                    <div class="team-card-image" style="width: 100%; height: 300px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); position: relative; overflow: hidden; border-radius: 0.75rem 0.75rem 0 0;">
                        <?php
                    ...
                    <div class="team-card-content" style="padding: 2rem; display: flex; flex-direction: column;">
                        ...
                        <p style="color: #000000; line-height: 1.7; margin-bottom: 1.5rem; font-size: 0.95rem; flex-grow: 1;">
                ...
                <div class="team-card" style="background: white; border-radius: 0.75rem; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; display: flex; flex-direction: column;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 12px rgba(0,0,0,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)';">
                    <div class="team-card-image" style="width: 100%; height: 300px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); position: relative; overflow: hidden; border-radius: 0.75rem 0.75rem 0 0;">
                        ...
                        if (file_exists(get_template_directory() . '/assets/images/doctors/karen-howald.jpg')) {
                            echo '<img src="' . esc_url($doctor3_image) . '" alt="Karen Howald" style="width: 100%; height: 100%; object-fit: cover;">';
                        } else {
                ...
                <div class="team-card" style="background: white; border-radius: 0.75rem; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; display: flex; flex-direction: column;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 12px rgba(0,0,0,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)';">
                    <div class="team-card-image" style="width: 100%; height: 300px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); position: relative; overflow: hidden; border-radius: 0.75rem 0.75rem 0 0;">
                        ...
                        if (file_exists(get_template_directory() . '/assets/images/doctors/emeka-owo.jpg')) {
                            echo '<img src="' . esc_url($doctor4_image) . '" alt="Emeka Owo" style="width: 100%; height: 100%; object-fit: cover;">';
                        } else {
