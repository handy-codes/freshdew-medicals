...
$show_fp_hero = freshdew_section_field_visible( $page_id, 'hero_title' )
...
<section style="padding: 4rem 0;">
    <div class="container">
        <div style="max-width: 900px; margin: 0 auto;">
            ...
            if ( $has_page_body && freshdew_section_field_visible( $page_id, 'family_editor_content' ) ) {
                echo '<div class="freshdew-page-content entry-content" style="margin-bottom: 3rem;">';
                the_content();
                echo '</div>';
            } elseif ( ! $has_page_body && freshdew_section_field_visible( $page_id, 'family_fallback_intro' ) ) {
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 2.5rem; margin-bottom: 3rem;">
                ...
                $family_services = array(
                    array(
                        ...
                        'theme_image' => 'pediatric-care.jpg', 'initials' => 'PC',
                    ),
                    array(
                        ...
                        'theme_image' => 'family-health.jpg', 'initials' => 'FH',
                    ),
                    array(
                        ...
                        'theme_image' => 'chronic-disease.jpg', 'initials' => 'CD',
                    ),
                    array(
                        'title_key' => 'service_4_title', 'desc_key' => 'service_4_description', 'img_key' => 'service_4_image',
                        ...
                        'theme_image' => 'vaccinations.jpg', 'initials' => 'VA',
                    ),
                );
            ...
            <?php
            $accept_box_vis = freshdew_section_field_visible( $page_id, 'accepting_heading' )
            ...
            <div style="background: #f0f9ff; border-left: 4px solid #2563eb; padding: 1.5rem; margin: 3rem 0; border-radius: 0.5rem;">
                <?php if ( freshdew_section_field_visible( $page_id, 'accepting_heading' ) ) : ?>
                <h3 style="font-size: 1.5rem; margin-bottom: 1rem; color: #1e40af;"><?php echo esc_html( freshdew_get_section( $page_id, 'accepting_heading', 'Accepting New Patients' ) ); ?></h3>
                <?php endif; ?>
                <?php if ( freshdew_section_field_visible( $page_id, 'accepting_text' ) ) : ?>
                <p style="color: #1e40af; margin: 0;"><?php echo esc_html( freshdew_get_section( $page_id, 'accepting_text', 'We are currently accepting new patients for our family practice. Please click below link to book your first appointment.' ) ); ?></p>
                <?php endif; ?>
            </div>
            <?php endif; ?>

            <?php if ( freshdew_section_field_visible( $page_id, 'family_book_banner' ) ) : ?>
